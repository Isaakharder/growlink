-- Pest Control device Calibration module — completion RPC (v2).
--
-- Recreated fresh after 0105 dropped the old function overload — see
-- 0105's header comment. Otherwise unchanged from 0104's current content.
--
