...
import { climateImportRouter } from "./routes/climateImportRoutes";
import { greenhouseSetupRouter } from "./routes/greenhouseSetup";
import { pestControlRouter } from "./routes/pestControl";
import { pestCalibrationRouter } from "./routes/pestCalibration";
import { h1Router } from "./routes/foodSafetyH1";
import { foodSafetyRouter } from "./routes/foodSafety";
import { qualityRouter } from "./routes/quality";
import { qualityBonusesRouter } from "./routes/qualityBonuses";
import { qualityBonusPdfImportRouter } from "./routes/qualityBonusPdfImport";
import { qualityBonusAdjustmentRouter } from "./routes/qualityBonusAdjustment";
import { healthRouter } from "./routes/health";
import { integrationsRouter } from "./routes/integrations";
import { wasteImportsRouter } from "./routes/wasteImports";
import { irrigationSetupRouter } from "./routes/irrigationSetup";
import { mobileDailyYieldRouter } from "./routes/mobileDailyYield";
import { dailyYieldSamplesRouter } from "./routes/dailyYieldSamples";
...
app.use("/api", adminDocklinkIntegrationsRouter);
...
app.use("/api", pestCalibrationRouter);
app.use("/api", h1Router);
app.use("/api", qualityRouter);
app.use("/api", qualityBonusesRouter);
app.use("/api", qualityBonusPdfImportRouter);
app.use("/api", qualityBonusAdjustmentRouter);
